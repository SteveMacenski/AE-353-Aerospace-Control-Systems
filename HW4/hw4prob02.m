...
% %%
%
% YOUR CODE HE RE TO COMPUTE t AND y(t)
%
%   I suggest defining an array of times from 0 to 5 that are spaced no
%   more than 1e-2 apart. by Steve Macenski
...
t = 0:1e-2:5;
for i = 1:length(t)
     y(:,i) = C*inv(A-B*K)*(expm((A-B*K)*t(i)))*B*Kref*r         -     C*inv(A-B*K)*B*Kref*r;;
end
...
function visualize(y,t) %by Professor Bretl
iCur = 1;
